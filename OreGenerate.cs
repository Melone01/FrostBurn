...

    {
...

        {
...

            {
                ...
                tasks.Insert(ShiniesIndex + 1, new PassLegacy("FrostBurn Ores", delegate (GenerationProgress progress)

                {

                    progress.Message = "Generating FrostBurn Ores";
...

                    {
                        ...
                        WorldGen.TileRunner(
                            ...
                            mod.TileType("OreTile1"), // The tile type that will be spawned
